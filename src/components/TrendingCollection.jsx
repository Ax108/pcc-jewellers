    ...
    <section id="trending-creations" className="bg-[#FAF8F5] py-16 sm:py-20 border-b border-neutral-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
          ...
          <Link
            to="/collections"
            className="inline-flex items-center gap-2 text-xs font-bold tracking-wider text-[#801424] hover:underline uppercase shrink-0"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURED_PRODUCTS.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="group flex flex-col rounded-xl border border-neutral-200 bg-white shadow-xs transition-all hover:border-[#801424]/40 hover:shadow-lg"
              >
                {/* Image & Badges */}
                <div className="relative aspect-square overflow-hidden rounded-t-xl bg-[#FAF6F0]">
                  ...
                  <div className="absolute top-3 left-3 flex flex-col gap-1 items-start">
                    <span className="rounded-full bg-white/95 px-2.5 py-0.5 text-[10px] font-semibold text-neutral-800 shadow-sm">
                      {product.badge}
                    </span>
                    {product.weight && (
                      <span className="rounded-full bg-neutral-900/80 px-2 py-0.5 text-[9px] font-medium text-amber-200">
                        {product.weight}
                      </span>
                    )}
                  </div>
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <div className="mt-auto pt-4 border-t border-neutral-100">
                    <button
                      ...
                      className={`flex w-full items-center justify-center gap-2 rounded-md py-2.5 text-xs font-semibold tracking-wider uppercase transition-colors ${
                        isAdded
